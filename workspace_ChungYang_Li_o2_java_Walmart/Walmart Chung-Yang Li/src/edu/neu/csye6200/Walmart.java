...
public class Walmart extends Store{
	...
	public static void demo3() {
		...
		System.out.println("\n lambda sort calories");
		List<LiteBread> inventory = new ArrayList<>();
		inventory.add(new LiteBread(7,2,6));
		inventory.add(new LiteBread(3,4,9));
		inventory.add(new LiteBread(5,9,1));
		inventory.add(new LiteBread(2,1,4));
		Collections.sort(inventory, (
				LiteBread a, LiteBread b)->a.getCalories() - b.getCalories()
				  );
